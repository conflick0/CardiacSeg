...
def get_ds_pths(data_dir):
    ...
    img_pths = []
    lbl_pths = []
    img_pths = list(map(lambda fn: os.path.join(data_dir, 'img', fn), sorted(os.listdir(os.path.join(data_dir, 'img')))))
    lbl_pths = list(map(lambda fn: os.path.join(data_dir, 'label', fn), sorted(os.listdir(os.path.join(data_dir, 'label')))))
