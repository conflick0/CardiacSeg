...
parser.add_argument("--space_x", default=0.78, type=float, help="spacing in x direction")
parser.add_argument("--space_y", default=0.78, type=float, help="spacing in y direction")
