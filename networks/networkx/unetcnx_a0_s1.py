...
from .blocks.ham import HAM
from .blocks.utils import LayerNorm, DilBlockConfig


class UNETCNX_A0_S1(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        self.skip_stem = HAM(feature_size * 2)
        self.skip_encoder1 = HAM(feature_size * 4)
        self.skip_encoder2 = HAM(feature_size * 8)
        self.skip_encoder3 = HAM(feature_size * 16)
        self.skip_encoder4 = HAM(feature_size * 32)
