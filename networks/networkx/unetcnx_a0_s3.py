...
from .blocks.cst import WideFocusBlock
from .blocks.utils import LayerNorm, DilBlockConfig


class UNETCNX_A0_S3(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        self.skip_stem = WideFocusBlock(feature_size * 2)
        self.skip_encoder1 = WideFocusBlock(feature_size * 4)
        self.skip_encoder2 = WideFocusBlock(feature_size * 8)
        self.skip_encoder3 = WideFocusBlock(feature_size * 16)
        self.skip_encoder4 = WideFocusBlock(feature_size * 32)
