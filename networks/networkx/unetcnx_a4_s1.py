...
class UNETCNX_A4_S1(nn.Module):
    def __init__(
        ...
        self.skip_encoder1 = HAM(feature_sizes[0])
        self.skip_encoder2 = HAM(feature_sizes[1])
        self.skip_encoder3 = HAM(feature_sizes[2])
        self.skip_encoder4 = HAM(feature_sizes[3])
        self.skip_encoder5 = HAM(feature_sizes[4])
