...
class UNETCNX_X3_2(nn.Module):
    def __init__(
        ...
        super().__init__()
        block_setting = [
            BlockConfig(feature_size * 2, feature_size * 4, 8),
            BlockConfig(feature_size * 4, feature_size * 8, 8),
            BlockConfig(feature_size * 8, feature_size * 16, 16),
            BlockConfig(feature_size * 16, feature_size * 32, 8)
        ]
