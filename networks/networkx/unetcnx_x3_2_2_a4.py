...
class UNETCNX_X3_2_2_A4(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        print(depths)
        block_setting = [
            DilBlockConfig(feature_size * 2, feature_size * 4, depths[0], [1, 1], [7, 7]),
            DilBlockConfig(feature_size * 4, feature_size * 8, depths[1], [1, 1], [7, 7]),
            DilBlockConfig(feature_size * 8, feature_size * 16, depths[2], [1, 1], [7, 7]),
