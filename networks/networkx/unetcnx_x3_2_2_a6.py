...
class UNETCNX_X3_2_2_A6(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        block_setting = [
            ...
            DilBlockConfig(feature_size * 8, feature_size * 16, depths[2], [1, 3], [7, 3]),
            DilBlockConfig(feature_size * 16, feature_size * 32, depths[3], [1, 3], [7, 3])
        ]
