...
class UNETCNX_X3_2_2_A7(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        self.skip_encoder0 = CBAM(feature_size * 2, reduction=16, kernel_size=7)
        self.skip_encoder1 = CBAM(feature_size * 4, reduction=16, kernel_size=7)
        self.skip_encoder2 = CBAM(feature_size * 8, reduction=16, kernel_size=7)
        self.skip_encoder3 = CBAM(feature_size * 16, reduction=16, kernel_size=7)
        self.skip_encoder4 = CBAM(feature_size * 32, reduction=16, kernel_size=7)
    ...
    def forward(self, x):
        ...
        skip_enc0 = self.skip_encoder0(inc)
        skip_enc1 = self.skip_encoder1(enc1)
        skip_enc2 = self.skip_encoder2(enc2)
        skip_enc3 = self.skip_encoder3(enc3)
        skip_enc4 = self.skip_encoder4(enc4)

        dec4 = self.encoder5(skip_enc4, skip_enc3)

        dec3 = self.decoder4(dec4, skip_enc2)
        dec2 = self.decoder3(dec3, skip_enc1)
        dec1 = self.decoder2(dec2, skip_enc0)
