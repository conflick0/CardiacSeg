...
from .blocks.utils import LayerNorm, BlockConfig


class UNETCNX_X4_1(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        for cnf in block_setting:
            ...
            for _ in range(cnf.num_layers):
                ...
                if stage_block_id % 2 == 0:
                    ...
                    stage.append(block(cnf.input_channels, sd_prob))
                else:
                    # even block is dil conv block
                    stage.append(block(cnf.input_channels, sd_prob, dilation=3))
                stage_block_id += 1
