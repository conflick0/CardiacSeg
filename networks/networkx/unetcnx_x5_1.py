...
class UNETCNX_X5_1(nn.Module):
    def __init__(
        ...
        super().__init__()
        block_setting = [
            DilBlockConfig(feature_size * 2, feature_size * 4, 8, [1, 16]),
            DilBlockConfig(feature_size * 4, feature_size * 8, 8, [1, 8]),
            DilBlockConfig(feature_size * 8, feature_size * 16, 16, [1, 2, 1, 3, 1, 4]),
            DilBlockConfig(feature_size * 16, feature_size * 32, 8, [1, 2])
        ]
