...
from .blocks.cst import ConvBlock_A9
from .blocks.utils import LayerNorm, DilBlockConfig


class UNETCST_A9(nn.Module):
    def __init__(
            self,
            in_channels=1,
            out_channels=2,
        ...
        # a9
        block_setting = [
                DilBlockConfig(feature_size * 2, feature_size * 4, depths[0], [1, 8], [7, 7]),
                DilBlockConfig(feature_size * 4, feature_size * 8, depths[1], [1, 4], [7, 7]),
                DilBlockConfig(feature_size * 8, feature_size * 16, depths[2], [1, 2], [7, 7]),
                DilBlockConfig(feature_size * 16, feature_size * 32, depths[3], [1, 1], [7, 7])
        ]
