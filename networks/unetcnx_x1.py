    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        block_setting: List[CNBlockConfig] = [
            CNBlockConfig(feature_size * 2, feature_size * 4, 2),
            CNBlockConfig(feature_size * 4, feature_size * 8, 2),
            CNBlockConfig(feature_size * 8, feature_size * 16, 2),
            CNBlockConfig(feature_size * 16, feature_size * 32, 2)
        ]
